...
public class Main {
    ...
    public static void createServer(){
        ...
        try{
            ...
            server = new Server(port, 1000, true, false);

            //connect this user to the server
            client = new Client("localhost", port, 1000, "Player", "Host", true, false);
    ...
    public static void gameWin(DataPackage pack){
        ...
        if (pack.get(0).equals("Win")) {
            ...
            //print who won's
            if (pack.get(1).equals(client.getUuid())) {
        ...
        try{
            ...
            if(input.contains("n") || input.contains("N")){
                ...
                DataPackage reply = client.sendRequest("reset");
    ...
    public static void waitForGameInput(int[] gameField, String playerOnTurn){
       ...
       try{
           ...
           if(field <= 9 && gameField[field-1] == -1){
               ...
               client.sendPackage(new DataPackage("makeTurn", (field-1)));
    ...
    public static void newTurn(int[] gameField, String playerOnTurn){
        ...
        if(playerOnTurn.equals(client.getUuid())){
            System.out.println("\n It's your turn");
        }else{
